...
public class Nomor7_SearchingSequential {
    ...
    public static void main(String[] args){
        ...
        int A[] = {25, 7, 9, 13, 3};
        Nomor7_SearchingSequential.tampil(A);
        Nomor7_SearchingSequential.insertionsort(A);
        Nomor7_SearchingSequential.tampil(A);
        Nomor7_SearchingSequential.sequential(search);
